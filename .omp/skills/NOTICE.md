...
|---|---|---|
| [brooks-lint](https://github.com/hyhmrright/brooks-lint) | Decay-risk rubric (R1–R6 / T1–T6), the Iron Law finding schema, and the Health Score — see `ctl-review`, `.ctl/spec/guides/{decay-risks,test-decay-risks,review-contract}.md` | MIT |
...
| [yao-bayesian-skill](https://github.com/yaojingang/yao-open-skills/tree/main/skills/yao-bayesian-skill) | Evidence grading (A–E), prior→posterior updating, and the disconfirming/falsification gate — see `ctl-diagnose`, `.ctl/spec/guides/failure-diagnosis.md` | MIT |
