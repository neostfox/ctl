...
description: "Capture knowledge from debugging, implementation, or discussion into .ctl/spec/. Auto-triggered by control-guard after a task finishes (ctl task finish), or after a ctl-oracle diagnosis reveals a pattern worth preserving."
---
