...
| [Cross-Layer Thinking Guide](./cross-layer-thinking-guide.md) | Think through data flow across CLI → Application → Domain → Store layers | Features spanning multiple layers, adding event types or boundary fields |
